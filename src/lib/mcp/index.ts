...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for Nikhil Raj's portfolio. Read the about, education, projects, skills, and services, or send a contact message via `send_contact_message`.",
  tools: [getAbout, getEducation, getProjects, getSkills, getServices, sendContactMessage],
});
