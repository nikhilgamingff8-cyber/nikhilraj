...
const Projects = () => {
  ...
  const featuredProject = {
    ...
    description:
      "The CampusX is a student-focused platform that helps users discover verified cashback campaigns and earning opportunities through step-by-step guides, tracker links, FAQs and community payment proofs.",
    features: [
